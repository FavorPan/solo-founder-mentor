...
> 综合出海一人公司五大互补方法流派（**AI 编程派** + **流量出海派** + **海外indie派·反VC极简** + **海外indie派·分发组合** + **社群共创派**）的可落地方法论，以「**泼冷水 + 方法论对照**」口吻为创业者解决困惑的 Claude Code Skill。
...
出海一人公司领域有五大互补方法流派，本 skill 把五派的可落地方法论整合到一起：

| 维度 | AI 编程派 | 流量出海派 | 海外indie派·反VC极简 | 海外indie派·分发组合 | 社群共创派 |
|---|---|---|---|---|---|
| 出身 | 大厂产品转型 | 电商运营转型 | 非程序员数字游民 | 被辞退后自雇 | 前阿里运营 |
| 核心能力 | AI 编程深度 + 产品洞察 | 流量/SEO + 内容执行力 | 极简技术栈 + 付费验证 | AI 编码工作流 + 个人IP | 信息差情报 + 社群机制 |
| 打法 | 少而精产品矩阵 | 广撒网站群 | 12个月12产品组合制 | 35+产品组合交叉销售 | 高粘性付费社群 + 共创实战 |
...
| 方法论重心 | 需求倒着做/养小龙虾/Ralph Loop | 五根方法论/机会分/数据复盘 | 付费验证/build in public/100%自动化 | Ship Fast/80-20 AI编码/组合变现 | 信息差+执行力+开放心态/阶梯涨价/双向筛选 |

前四派都不是程序员科班，都靠 AI 写代码做出千万级营收，偏"做产品"；第五派偏"做社群+情报+孵化"，是前几派的圈层母体——其中 AI 编程派、流量出海派的代表人物本就出自该派社群。前两派+社群派偏中国出海，后两派偏全球视角，东西方对照。路径可复制，方法论可落地。
